...
EXPERIMENT_NAME = "windowed_EachDevice-200k_batch-512_learningRate-0.0001_stride-20_distances-62_epochs-50"
...
def get_shuffled_and_windowed_from_pregen_ds():
    ...
    path = os.path.join(utils.get_datasets_base_path(), "automated_windower", "windowed_EachDevice-200k_batch-100_stride-20_distances-62")
    print(path)
