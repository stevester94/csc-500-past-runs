...
for desired_batch_size in 64; do
for epochs in 5; do
...
for seed in 8646 25792 15474 5133 30452 17665 27354 17752; do
    experiment_name=yolo_deeper_tipoff_seed-${seed}_distance-${distance}_learningRate-${learning_rate}_batch-${desired_batch_size}_epochs-${epochs}_patience-$patience
