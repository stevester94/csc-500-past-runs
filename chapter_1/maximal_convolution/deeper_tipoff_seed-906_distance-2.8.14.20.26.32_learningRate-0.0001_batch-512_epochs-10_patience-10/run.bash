...
for seed in 906  2856 3007 7701 1337; do
    experiment_name=deeper_tipoff_seed-${seed}_distance-${distance}_learningRate-${learning_rate}_batch-${desired_batch_size}_epochs-${epochs}_patience-$patience
