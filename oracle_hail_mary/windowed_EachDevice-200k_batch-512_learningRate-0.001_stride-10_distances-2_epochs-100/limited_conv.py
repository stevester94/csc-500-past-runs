...
EXPERIMENT_NAME = "windowed_EachDevice-200k_batch-512_learningRate-0.001_stride-10_distances-2_epochs-100"
...
def get_shuffled_and_windowed_from_pregen_ds():
    ...
    path = os.path.join(utils.get_datasets_base_path(), "automated_windower", "windowed_EachDevice-200k_batch-100_stride-10_distances-2")
    print(path)
