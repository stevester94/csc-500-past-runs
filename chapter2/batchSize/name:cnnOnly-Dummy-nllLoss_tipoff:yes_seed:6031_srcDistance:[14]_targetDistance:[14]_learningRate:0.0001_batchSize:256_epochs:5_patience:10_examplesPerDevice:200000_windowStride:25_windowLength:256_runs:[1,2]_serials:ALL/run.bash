...
results_base_path="$CSC500_ROOT_PATH/csc500-past-runs/chapter2/batchSize"
...
for seed in 25792 15474 5133 6107 6031 1924 1710 2293; do
for batch_size in 32 128 256 512; do
for epochs in 5; do
