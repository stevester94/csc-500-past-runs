...
print("batch_size", "window_stride","SourceTestLabelLoss","batch_size","source_distance", sep=",")

for e in experiments:
    #print(e)
    #sys.exit(1)
    print(e["batch_size"], e["window_stride"], e["SourceTestLabelLoss"], e["batch_size"], str(e["source_distance"]).replace(",", '.'), sep=",")
